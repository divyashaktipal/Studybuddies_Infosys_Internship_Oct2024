  ...
  return (
    <div className="bg-gradient-to-b from-green-50 to-green-200 min-h-screen">
      <nav className="flex justify-between items-center p-4 bg-white px-8 text-white relative z-10 m-0">
        ...
        <div
          className={`hidden md:flex items-center gap-6 transition-transform duration-300 ${
            isOpen ? "open" : ""
          }`}
        >
          <a
            href="/main-page"
            className="font-bold text-black hover:text-green-700 transition-colors duration-300"
          >
            Home
          </a>
          <a
        ...
        <div
          className={`absolute top-full left-0 bg-gray-800 w-full ${
            isOpen ? "flex" : "hidden"
          } flex-col p-4 md:hidden`}
        >
          <a
            href="/home"
            className="block text-white hover:text-yellow-400 transition-colors duration-300 p-2"
          >
            Home
          </a>
          <a
        ...
        <div id="main-content" className="main-content">
          <div className="p-4 rounded-lg shadow-lg bg-white">
            ...
            <div className="flex justify-end gap-5 space-x-4 mt-6">
              <button
                className="bg-white text-green-500 font-extrabold text-2xl border border-green-500 py-2 px-4 shadow-md hover:bg-green-500 hover:text-white transition-colors duration-300"
